...
class Audio extends Component {
  constructor(props) {
    ...
    this.trackerIsInsideOfSmallCircle =
      this.trackerIsInsideOfSmallCircle.bind(this);
    this.trackerIsOusideOfBigCircle =
      this.trackerIsOusideOfBigCircle.bind(this);
    // @Controls
  ...
  preLoadCompleteSong() {
    ...
    let { audioStreamData, audioLoadOffsetTime, audioContextCreatedTime } =
      this.state;
  ...
  framerGetSize(angle, l, r) {
    const { framerMaxTickSize, framerTickSize, framerIndex, framerCountTicks } =
      this.state;
    const m = (r - l) / 2;
    const x = angle - l;
    let size;
  ...
  trackerStartAnimation() {
    const { trackerAnimationCount, trackerPrevAngle, trackerAngle } =
      this.state;
  ...
  trackerIsInsideOfSmallCircle(event) {
    let { canvasCx, canvasCy, canvasCoord, sceneRadius, trackerInnerDelta } =
      this.state;
